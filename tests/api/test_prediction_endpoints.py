...
class TestPredictionEndpoints:
    ...
    def test_predict_endpoint_returns_valid_prediction_data(self, auth_headers, sample_prediction_data):
    ...
    def test_predict_endpoint_response_time_under_threshold(self, auth_headers, sample_prediction_data):
