...
class AuthService:
    ...
    def create_default_admin(self):
        ...
        cursor.execute("""
            INSERT INTO users (username, email, password_hash, salt, role, is_active)
            VALUES (?, ?, ?, ?, ?, ?)
        """, ("testuser", "test@ia-continu.local", test_password_hash, test_salt, "user", True))
    ...
    def create_user(self, user_data: UserCreate) -> User:
        ...
        try:
            ...
            cursor.execute("""
                INSERT INTO users (username, email, password_hash, salt, role, is_active)
                VALUES (?, ?, ?, ?, ?, ?)
            """, (user_data.username, user_data.email, password_hash, salt, user_data.role, True))
    ...
    def authenticate_user(self, username: str, password: str) -> Optional[User]:
        ...
        try:
            ...
            user_id, username, email, password_hash, salt, role, is_active, created_at = row
