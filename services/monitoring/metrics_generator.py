...
def generate_ml_metrics():
    ...
    try:
        ...
        print(
            f"📊 ML Metrics: Accuracy={metrics['model_accuracy']:.3f}, "
...
def generate_system_metrics():
    ...
    try:
        ...
        print(
            f"🖥️ System Metrics: CPU={metrics['cpu_usage']:.1f}%, "
...
def run_metrics_cycle():
    ...
    # Log summary
    print(
        f"📈 Metrics cycle completed - API: {'✅' if api_success else '❌'}, "
    ...
    while True:
        try:
            ...
            if cycle_count % 10 == 0:
                ...
                print("🔄 Next summary in 10 cycles\n")
